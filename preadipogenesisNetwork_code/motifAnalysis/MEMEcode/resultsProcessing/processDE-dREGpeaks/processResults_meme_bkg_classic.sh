...
datdir=bkg_0.1_classic_pairwise_memeResults
mkdir ${datdir}
...
####################################################
## isolate all motifs with E-values
...
nrow(Edat) # 181 motifs
nrow(motifs.unq) # 133 unique motifs
...
fname = "all_sig_motifs_bkg_0.1_classic.txt"
...
dir=/nv/vol192/civeleklab/warren/MGlab/ATAC_WAFD/3T3_ATAC1-3/motifs/meme/dreg_for_meme/bkg_0.1_classic/bkg_0.1_classic_pairwise_memeResults
cd ${dir}
mkdir pswm

...
datdir=nobkg_0.1_de_pairwise_memeResults
mkdir ${datdir}
...
nrow(Edat) # 778 motifs
nrow(motifs.unq) # 555 unique motifs
...
fname = "all_sig_motifs_nobkg_0.1_de.txt"
...
dir=/nv/vol192/civeleklab/warren/MGlab/ATAC_WAFD/3T3_ATAC1-3/motifs/meme/dreg_for_meme/nobkg_0.1_de/nobkg_0.1_de_pairwise_memeResults
cd ${dir}
mkdir pswm

# directory for meme pswms to be used with tomtom
# mkdir pswm
cp ${dir}/memeEval/*de.txt ${dir}/pswm
cp ${dir}/memeEval/*RData ${dir}/pswm
cd ${dir}/pswm


-bash-4.2$pwd
/nv/vol192/civeleklab/warren/MGlab/ATAC_WAFD/3T3_ATAC1-3/motifs/meme/dreg_for_meme/nobkg_0.1_de/nobkg_0.1_de_pairwise_memeResults/pswm

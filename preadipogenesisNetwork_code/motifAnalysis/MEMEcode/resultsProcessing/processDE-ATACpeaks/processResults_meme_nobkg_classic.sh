...
dir=/scratch/wa3j/deseq_res/nobkg_0.1_classic
cd ${dir}
...
datdir=nobkg_0.1_classic_pairwise_memeResults
mkdir ${datdir}

# folders with meme data
folders=$(ls -d *condit_id*/)
...
subdir=nobkg_0.1_classic_pairwise_memeResults
dir=/nv/vol192/civeleklab/warren/MGlab/ATAC_WAFD/3T3_ATAC1-3/motifs/meme/deseq_res/nobkg_0.1_classic
dir=/scratch/wa3j/deseq_res/nobkg_0.1_classic
cd ${dir}/${subdir}

# document meme run conditions
comp=nobkg_0.1_classic
...
nrow(Edat) # 198 motifs
nrow(motifs.unq) # 186 unique motifs
...
fname = "all_sig_motifs_nobkg_0.1_classic.txt"
...
dir=/nv/vol192/civeleklab/warren/MGlab/ATAC_WAFD/3T3_ATAC1-3/motifs/meme/deseq_res/nobkg_0.1_classic/nobkg_0.1_classic_pairwise_memeResults
dir=/scratch/wa3j/deseq_res/nobkg_0.1_classic/nobkg_0.1_classic_pairwise_memeResults
cd ${dir}
mkdir pswm

# directory for meme pswms to be used with tomtom
# mkdir pswm
cp ${dir}/memeEval/*classic.txt ${dir}/pswm
cp ${dir}/memeEval/*RData ${dir}/pswm
cd ${dir}/pswm


-bash-4.2$pwd
/nv/vol192/civeleklab/warren/MGlab/ATAC_WAFD/3T3_ATAC1-3/motifs/meme/deseq_res/nobkg_0.1_classic/nobkg_0.1_classic_pairwise_memeResults/pswm

/scratch/wa3j/deseq_res/nobkg_0.1_classic/nobkg_0.1_classic_pairwise_memeResults/pswm

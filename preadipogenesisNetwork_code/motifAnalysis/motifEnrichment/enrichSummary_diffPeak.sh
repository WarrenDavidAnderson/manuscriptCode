...
dir=/scratch/wa3j/enrich_diffPeak
cd ${dir}

# move data - differential atac peak data
from=/media/wa3j/Seagate2/Documents/PRO/adipogenesis/July2018/atac_time_deg/motifEnrich/deg/enrichdat_600bp_step20.RData
to=/scratch/wa3j/enrich_diffPeak
...
# based on a set number of peaks (e.g., 500k or 750k)
...
save(fac.chisq, file="enrichdatProcessed750k.RData")

# move data for local analysis
to=/media/wa3j/Seagate2/Documents/PRO/adipogenesis/July2018/atac_time_deg/motifEnrich/deg
from=/scratch/wa3j/enrich_diffPeak/Rtxt/enrichdatProcessed750k.RData
scp -r wa3j@interactive.hpc.virginia.edu:${from} ${to}

# analysis
Motif_in_peak_diffPeak.R
